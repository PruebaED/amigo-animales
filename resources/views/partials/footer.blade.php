	...
	<footer class="row footer mt-5">
		...
		<div class="footer-col mt-xl-5 col-md-6 col-xl-3 offset-xl-1">
			...
			<ul>
				<li>
				  @if (isset($animal->animal_id))
						<a href="../../downloadables/privacy-policy.pdf" target="_blank">
		...
		<div class="footer-col mt-xl-5 col-md-6 col-xl-3 offset-xl-1">
			<h4>Contacto</h4>
			<ul>
				<li><a href="/contact/information">Teléfono: +34 123 456 789</a></li>
				<li><a href="/contact/information">Email: soporteamigoanimales@gmail.com</a></li>
				<li><a href="/contact/information">Localización: Calle Inventada Nº23</a></li>
			</ul>
		</div>
		<div class="footer-col mt-xl-5 col-md-6 col-xl-3 offset-xl-1">
			<h4>Síguenos</h4>
