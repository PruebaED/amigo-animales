                ...
                <form method="POST" action="/animals/missings/post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-10 offset-1 mb-5">
                      ...
                      <select class="form-control select-provincia" name="missingAnimalProvince" onmousedown="this.size=6;" onchange='this.size=0;' onblur="this.size=0;">
                    ...
                    <div class="col-10 offset-1 mb-5">
                      ...
                      <select class="form-control select-custom" name="missingAnimalGender" onmousedown="this.size=3;" onchange='this.size=0;' onblur="this.size=0;">
                    ...
                    <form method="POST">
                      ...
                      <div class="row">
                        ...
                        <div class="col-10 offset-1 mb-5">
                          ...
                          <select class="form-control select-provincia" name="reportSelect" onmousedown="this.size=6;" onchange='this.size=0;' onblur="this.size=0;">
                            <option disabled selected>Seleccione una provincia</option>
                            @foreach($provinces as $key => $province) 
