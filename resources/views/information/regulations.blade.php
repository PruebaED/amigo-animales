      ...
      <section class="row">
        <div class="col-10 col-xl-4 offset-1"> 
          ...
          <p class="justificado mt-5"> 
            <img class="icono mx-3" src="imagenes/pdf.png" alt=""> <a class="link" href="downloadables/municipal-ordinance.pdf" target="_blank">Ordenanza municipal</a>
          </p>
        </div>
        <div class="col-10 col-xl-4 offset-1 offset-xl-2"> 
          ...
          <hr>
          <p class="justificado"> 
            <img class="icono mx-3" src="imagenes/pdf.png" alt=""> <a class="link" href="downloadables/state-ordinance1.pdf" target="_blank">Ley 10/1990</a>
          </p>
          <p class="justificado mt-5"> 
            <img class="icono mx-3" src="imagenes/pdf.png" alt=""> <a class="link" href="downloadables/state-ordinance2.pdf" target="_blank">Ley 50/1999</a>
          </p>
          <p class="justificado mt-5"> 
            <img class="icono mx-3" src="imagenes/pdf.png" alt=""> <a class="link" href="downloadables/state-ordinance2.pdf" target="_blank">R.D. 287/2002</a>
          </p>
          <p class="justificado mt-5"> 
            <img class="icono mx-3" src="imagenes/pdf.png" alt=""> <a class="link" href="downloadables/state-ordinance2.pdf" target="_blank">Orden 29/06/13</a>
          </p>
        </div>
      </section>
      <!-- ... -->
