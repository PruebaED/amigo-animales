...
<html lang="en">
  ...
  <head>
    ...
    <title>Establece tu contraseña - El Amigo de los Animales</title>
        ...
        <div class="user">
          <div class="formBx formRegister">
            <form method="POST">
              ...
              <input class="form-control" type="text" name="passwordResetSettedEmail" placeholder="Email" value="{{ old('passwordResetSettedEmail') }}">
